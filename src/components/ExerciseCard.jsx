	...
	return (
		<button
			...
			<div className="flex flex-col sm:flex-row">
				{/* GIF area */}
				<div className="relative w-full sm:w-56 md:w-64 aspect-video sm:aspect-[4/3] bg-[hsl(var(--bg))] overflow-hidden flex-shrink-0">
					{!imgLoaded && !imgError && (
					...
					{imgError ? (
						...
						<img
							...
							className={`w-full h-full object-contain sm:object-cover transition-opacity duration-300 ${imgLoaded ? "opacity-100" : "opacity-0"}`}
						/>
					)}
				</div>
				...
				<div className="p-4 sm:p-5 flex-1 min-w-0">
					<div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-3">
						<div className="min-w-0">
							<h3 className="font-semibold text-[hsl(var(--fg))] leading-snug capitalize line-clamp-2 mb-3 group-hover:text-[hsl(var(--primary))] transition-colors text-lg">
								{exercise.name}
							</h3>
						...
						<p className="text-xs text-[hsl(var(--muted))] capitalize lg:text-right whitespace-nowrap">
							<span className="font-medium text-[hsl(var(--fg))]/70">
								Target:{" "}
							</span>
							{muscle}
						</p>
					...
					<div className="mt-4 rounded-xl border border-[hsl(var(--border))] bg-[hsl(var(--bg))]/60 p-4">
						<p className="text-[0.7rem] font-semibold uppercase tracking-[0.2em] text-[hsl(var(--muted))] mb-2">
							Overview
						</p>
						<p className="text-sm leading-relaxed text-[hsl(var(--fg))]/80 line-clamp-3 min-h-[4.5rem]">
